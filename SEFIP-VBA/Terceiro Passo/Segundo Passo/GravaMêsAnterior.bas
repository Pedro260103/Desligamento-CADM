Attribute VB_Name = "GravaMêsAnterior"
Sub GravarMesAnterior()
    ...
    LocalDoArquivo = "X:\GESFO - ISO\GERINS em ES250-89\SEFIP\2018-RETIFICADORAS\08-2018-(1ª Retificadora)\CADM\SEFIP - Codigo.RE"
    NumArquivo = FreeFile
...
Function ConverterDataComBarra(ByVal DataAdmissaoTXTCima As String) As String
    ...
    If Len(DataAdmissaoTXTCima) <> 8 Then
        ConverterDataComBarra = "Data inválida"
        Exit Function
    End If
